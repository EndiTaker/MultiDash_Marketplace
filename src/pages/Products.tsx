...
import { useProductsWithSupabase } from "@/hooks/useProductsWithSupabase";
...
export function Products() {
  ...
  const { products, loading, stats, toggleProductStatus, refreshProducts } =
    useProductsWithSupabase({
            ...
            <tbody>
              {products.map((product, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-4">
                    <span
                      className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${statusColors[product.status]}`}
                    >
